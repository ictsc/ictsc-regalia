...
require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.6-20240717164558-a6c49f84cc0f.1
...
require (
	buf.build/gen/go/bufbuild/bufplugin/protocolbuffers/go v1.36.6-20241023225133-42bdb4b67625.1 // indirect
