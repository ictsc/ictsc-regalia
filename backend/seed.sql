...
INSERT INTO answers (id, problem_id, team_id, number, user_id, created_at_range) VALUES
	...
	-- 0005 OSPF経路制御 (max_score=200)
	('a0000001-0000-4000-8000-000000000001', '57b9d023-8100-4265-b48e-e4e42e507d25', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 1, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 01:00:00+00', '2025-02-03 01:20:00+00')),
	('a0000001-0000-4000-8000-000000000002', '57b9d023-8100-4265-b48e-e4e42e507d25', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 2, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 02:00:00+00', '2025-02-03 02:20:00+00')),
	('a0000001-0000-4000-8000-000000000003', '57b9d023-8100-4265-b48e-e4e42e507d25', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 3, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 03:00:00+00', '2025-02-03 03:20:00+00')),
	-- 0006 Webサーバー構築 (max_score=150)
	('a0000002-0000-4000-8000-000000000001', '68cae134-9211-4376-a59f-f5f53f618e36', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 1, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 01:30:00+00', '2025-02-03 01:50:00+00')),
	('a0000002-0000-4000-8000-000000000002', '68cae134-9211-4376-a59f-f5f53f618e36', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 2, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 03:30:00+00', '2025-02-03 03:50:00+00')),
	-- 0007 ファイアウォール設定 (max_score=300)
	('a0000003-0000-4000-8000-000000000001', '79dbe245-a322-4487-b6a0-060640729f47', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 1, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 02:30:00+00', '2025-02-03 02:50:00+00')),
	-- 0008 コンテナ運用管理 (max_score=250) — 未採点
	('a0000004-0000-4000-8000-000000000001', '8aecf356-b433-4598-87b1-171751830058', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 1, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 04:00:00+00', '2025-02-03 04:20:00+00')),
	-- 0004 全期間問題 (max_score=500)
	('a0000005-0000-4000-8000-000000000001', '46a8cf12-7fef-6154-a37d-f3d31d396c14', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 1, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 04:30:00+00', '2025-02-03 04:50:00+00')),
	('a0000005-0000-4000-8000-000000000002', '46a8cf12-7fef-6154-a37d-f3d31d396c14', 'a1de8fe6-26c8-42d7-b494-dea48e409091', 2, '3a4ca027-5e02-4ade-8e2d-eddb39adc235', tstzrange('2025-02-03 05:00:00+00', '2025-02-03 05:20:00+00'));
...
INSERT INTO descriptive_answers (answer_id, body) VALUES
	...
	('a0000001-0000-4000-8000-000000000001', 'OSPF経路制御: area 0 を設定しました'),
	('a0000001-0000-4000-8000-000000000002', 'OSPF経路制御: redistribute connected を追加'),
	('a0000001-0000-4000-8000-000000000003', 'OSPF経路制御: cost を調整して最適経路を設定'),
	('a0000002-0000-4000-8000-000000000001', 'Webサーバー: nginx.conf のバーチャルホスト設定'),
	('a0000002-0000-4000-8000-000000000002', 'Webサーバー: SSL証明書を設定しHTTPS有効化'),
	('a0000003-0000-4000-8000-000000000001', 'ファイアウォール: nftables でフィルタリングルール作成'),
	('a0000004-0000-4000-8000-000000000001', 'コンテナ: docker logs で原因特定、Dockerfile修正'),
	('a0000005-0000-4000-8000-000000000001', '総合: まずネットワーク疎通を確認'),
	('a0000005-0000-4000-8000-000000000002', '総合: 全サービス復旧を確認');
...
INSERT INTO marking_results (id, answer_id, judge_name, visibility, created_at) VALUES
	...
	-- 0005 の採点 (提出1: 0点, 提出2: 100点, 提出3: 200点満点)
	('b0000001-0000-4000-8000-000000000001', 'a0000001-0000-4000-8000-000000000001', 'judge', 'PUBLIC',  '2025-02-03 01:30:00+00'),
	('b0000001-0000-4000-8000-000000000002', 'a0000001-0000-4000-8000-000000000002', 'judge', 'PUBLIC',  '2025-02-03 02:30:00+00'),
	('b0000001-0000-4000-8000-000000000003', 'a0000001-0000-4000-8000-000000000003', 'judge', 'PUBLIC',  '2025-02-03 03:30:00+00'),
	-- 0006 の採点 (提出1: 80点, 提出2: 150点満点)
	('b0000002-0000-4000-8000-000000000001', 'a0000002-0000-4000-8000-000000000001', 'judge', 'PUBLIC',  '2025-02-03 02:00:00+00'),
	('b0000002-0000-4000-8000-000000000002', 'a0000002-0000-4000-8000-000000000002', 'judge', 'PUBLIC',  '2025-02-03 04:00:00+00'),
	-- 0007 の採点 (提出1: 150点, ペナルティ30点)
	('b0000003-0000-4000-8000-000000000001', 'a0000003-0000-4000-8000-000000000001', 'judge', 'PUBLIC',  '2025-02-03 03:00:00+00'),
	-- 0004 の採点 (提出1: 200点, 提出2: 350点)
	('b0000005-0000-4000-8000-000000000001', 'a0000005-0000-4000-8000-000000000001', 'judge', 'PUBLIC',  '2025-02-03 05:00:00+00'),
	('b0000005-0000-4000-8000-000000000002', 'a0000005-0000-4000-8000-000000000002', 'judge', 'PUBLIC',  '2025-02-03 05:30:00+00');
	-- 0008 は未採点
...
INSERT INTO descriptive_marking_rationales (marking_result_id, rationale) VALUES
	...
	('b0000001-0000-4000-8000-000000000001', 'area設定のみでは不十分'),
	('b0000001-0000-4000-8000-000000000002', 'redistribute の設定は正しいが cost 調整が不足'),
	('b0000001-0000-4000-8000-000000000003', '完璧な設定'),
	('b0000002-0000-4000-8000-000000000001', 'バーチャルホストはOK、SSLが未設定'),
	('b0000002-0000-4000-8000-000000000002', '完璧な設定'),
	('b0000003-0000-4000-8000-000000000001', 'フィルタリングは概ね正しいがICMP許可漏れ'),
	('b0000005-0000-4000-8000-000000000001', 'ネットワーク疎通のみ確認、サービス復旧は未着手'),
	('b0000005-0000-4000-8000-000000000002', 'ほぼ全サービス復旧、一部ログ設定が不足');

TRUNCATE TABLE scores CASCADE;
INSERT INTO scores (marking_result_id, marked_score, penalty) VALUES
	('862b646a-5fdd-4a77-bb2d-7ef5d4f1d069', 8, 0),
	('358ebef7-c626-44fa-9a3d-da2d9083fe5e', 7, 0),
	('87cb974d-dedd-4039-a189-b34f3a57e62c', 80, 0),
	('b0000001-0000-4000-8000-000000000001', 0, 0),
	('b0000001-0000-4000-8000-000000000002', 100, 0),
	('b0000001-0000-4000-8000-000000000003', 200, 0),
	('b0000002-0000-4000-8000-000000000001', 80, 0),
	('b0000002-0000-4000-8000-000000000002', 150, 0),
	('b0000003-0000-4000-8000-000000000001', 150, 30),
	('b0000005-0000-4000-8000-000000000001', 200, 0),
	('b0000005-0000-4000-8000-000000000002', 350, 0);
...
INSERT INTO answer_scores (answer_id, visibility, marking_result_id) VALUES
	...
	-- 0005
	('a0000001-0000-4000-8000-000000000001', 'PUBLIC', 'b0000001-0000-4000-8000-000000000001'),
	('a0000001-0000-4000-8000-000000000001', 'TEAM', 'b0000001-0000-4000-8000-000000000001'),
	('a0000001-0000-4000-8000-000000000001', 'PRIVATE', 'b0000001-0000-4000-8000-000000000001'),
	('a0000001-0000-4000-8000-000000000002', 'PUBLIC', 'b0000001-0000-4000-8000-000000000002'),
	('a0000001-0000-4000-8000-000000000002', 'TEAM', 'b0000001-0000-4000-8000-000000000002'),
	('a0000001-0000-4000-8000-000000000002', 'PRIVATE', 'b0000001-0000-4000-8000-000000000002'),
	('a0000001-0000-4000-8000-000000000003', 'PUBLIC', 'b0000001-0000-4000-8000-000000000003'),
	('a0000001-0000-4000-8000-000000000003', 'TEAM', 'b0000001-0000-4000-8000-000000000003'),
	('a0000001-0000-4000-8000-000000000003', 'PRIVATE', 'b0000001-0000-4000-8000-000000000003'),
	-- 0006
	('a0000002-0000-4000-8000-000000000001', 'PUBLIC', 'b0000002-0000-4000-8000-000000000001'),
	('a0000002-0000-4000-8000-000000000001', 'TEAM', 'b0000002-0000-4000-8000-000000000001'),
	('a0000002-0000-4000-8000-000000000001', 'PRIVATE', 'b0000002-0000-4000-8000-000000000001'),
	('a0000002-0000-4000-8000-000000000002', 'PUBLIC', 'b0000002-0000-4000-8000-000000000002'),
	('a0000002-0000-4000-8000-000000000002', 'TEAM', 'b0000002-0000-4000-8000-000000000002'),
	('a0000002-0000-4000-8000-000000000002', 'PRIVATE', 'b0000002-0000-4000-8000-000000000002'),
	-- 0007
	('a0000003-0000-4000-8000-000000000001', 'PUBLIC', 'b0000003-0000-4000-8000-000000000001'),
	('a0000003-0000-4000-8000-000000000001', 'TEAM', 'b0000003-0000-4000-8000-000000000001'),
	('a0000003-0000-4000-8000-000000000001', 'PRIVATE', 'b0000003-0000-4000-8000-000000000001'),
	-- 0004
	('a0000005-0000-4000-8000-000000000001', 'PUBLIC', 'b0000005-0000-4000-8000-000000000001'),
	('a0000005-0000-4000-8000-000000000001', 'TEAM', 'b0000005-0000-4000-8000-000000000001'),
	('a0000005-0000-4000-8000-000000000001', 'PRIVATE', 'b0000005-0000-4000-8000-000000000001'),
	('a0000005-0000-4000-8000-000000000002', 'PUBLIC', 'b0000005-0000-4000-8000-000000000002'),
	('a0000005-0000-4000-8000-000000000002', 'TEAM', 'b0000005-0000-4000-8000-000000000002'),
	('a0000005-0000-4000-8000-000000000002', 'PRIVATE', 'b0000005-0000-4000-8000-000000000002');
...
INSERT INTO problem_scores (team_id, problem_id, visibility, marking_result_id, updated_at) VALUES
	...
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '57b9d023-8100-4265-b48e-e4e42e507d25', 'PUBLIC', 'b0000001-0000-4000-8000-000000000003', '2025-02-03 03:30:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '57b9d023-8100-4265-b48e-e4e42e507d25', 'TEAM', 'b0000001-0000-4000-8000-000000000003', '2025-02-03 03:30:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '57b9d023-8100-4265-b48e-e4e42e507d25', 'PRIVATE', 'b0000001-0000-4000-8000-000000000003', '2025-02-03 03:30:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '68cae134-9211-4376-a59f-f5f53f618e36', 'PUBLIC', 'b0000002-0000-4000-8000-000000000002', '2025-02-03 04:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '68cae134-9211-4376-a59f-f5f53f618e36', 'TEAM', 'b0000002-0000-4000-8000-000000000002', '2025-02-03 04:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '68cae134-9211-4376-a59f-f5f53f618e36', 'PRIVATE', 'b0000002-0000-4000-8000-000000000002', '2025-02-03 04:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '79dbe245-a322-4487-b6a0-060640729f47', 'PUBLIC', 'b0000003-0000-4000-8000-000000000001', '2025-02-03 03:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '79dbe245-a322-4487-b6a0-060640729f47', 'TEAM', 'b0000003-0000-4000-8000-000000000001', '2025-02-03 03:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '79dbe245-a322-4487-b6a0-060640729f47', 'PRIVATE', 'b0000003-0000-4000-8000-000000000001', '2025-02-03 03:00:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '46a8cf12-7fef-6154-a37d-f3d31d396c14', 'PUBLIC', 'b0000005-0000-4000-8000-000000000002', '2025-02-03 05:30:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '46a8cf12-7fef-6154-a37d-f3d31d396c14', 'TEAM', 'b0000005-0000-4000-8000-000000000002', '2025-02-03 05:30:00+00'),
	('a1de8fe6-26c8-42d7-b494-dea48e409091', '46a8cf12-7fef-6154-a37d-f3d31d396c14', 'PRIVATE', 'b0000005-0000-4000-8000-000000000002', '2025-02-03 05:30:00+00');
