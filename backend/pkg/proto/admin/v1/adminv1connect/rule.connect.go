...
const (
	...
	RuleServiceUpdateRuleProcedure = "/admin.v1.RuleService/UpdateRule"
)
...
func NewRuleServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RuleServiceClient {
	...
	ruleServiceMethods := v1.File_admin_v1_rule_proto.Services().ByName("RuleService").Methods()
...
// UpdateRule calls admin.v1.RuleService.UpdateRule.
...
func (UnimplementedRuleServiceHandler) UpdateRule(context.Context, *connect.Request[v1.UpdateRuleRequest]) (*connect.Response[v1.UpdateRuleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admin.v1.RuleService.UpdateRule is not implemented"))
}
