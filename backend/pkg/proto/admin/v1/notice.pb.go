...
var file_admin_v1_notice_proto_rawDesc = []byte{
...
var (
	...
	file_admin_v1_notice_proto_rawDescData = file_admin_v1_notice_proto_rawDesc
)

func file_admin_v1_notice_proto_rawDescGZIP() []byte {
	file_admin_v1_notice_proto_rawDescOnce.Do(func() {
		file_admin_v1_notice_proto_rawDescData = protoimpl.X.CompressGZIP(file_admin_v1_notice_proto_rawDescData)
	})
...
func file_admin_v1_notice_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_admin_v1_notice_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_admin_v1_notice_proto_rawDesc = nil
