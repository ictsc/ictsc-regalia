...
var file_contestant_v1_contest_proto_rawDesc = []byte{
...
var (
	...
	file_contestant_v1_contest_proto_rawDescData = file_contestant_v1_contest_proto_rawDesc
)

func file_contestant_v1_contest_proto_rawDescGZIP() []byte {
	file_contestant_v1_contest_proto_rawDescOnce.Do(func() {
		file_contestant_v1_contest_proto_rawDescData = protoimpl.X.CompressGZIP(file_contestant_v1_contest_proto_rawDescData)
	})
...
func file_contestant_v1_contest_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_contestant_v1_contest_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_contestant_v1_contest_proto_rawDesc = nil
