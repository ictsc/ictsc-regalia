...
var file_admin_v1_ranking_proto_goTypes = []interface{}{
...
func file_admin_v1_ranking_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_admin_v1_ranking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Rank); i {
			case 0:
				return &v.state
			case 1:
		...
		file_admin_v1_ranking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_admin_v1_ranking_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
