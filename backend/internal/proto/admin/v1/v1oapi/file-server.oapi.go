...
// ファイルをアップロード
// (POST /files)
func (_ Unimplemented) PostFile(w http.ResponseWriter, r *http.Request) {
...
func (siw *ServerInterfaceWrapper) PostFile(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PostFile(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/files", wrapper.PostFile)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/files/{fileId}", wrapper.GetFile)
	})
