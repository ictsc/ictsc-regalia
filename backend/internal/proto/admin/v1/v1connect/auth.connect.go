...
const (
	...
	AuthServiceGetCallbackProcedure = "/admin.v1.AuthService/GetCallback"
	// AuthServicePostCodeProcedure is the fully-qualified name of the AuthService's PostCode RPC.
	AuthServicePostCodeProcedure = "/admin.v1.AuthService/PostCode"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	authServiceServiceDescriptor           = v1.File_admin_v1_auth_proto.Services().ByName("AuthService")
...
// GetCallback calls admin.v1.AuthService.GetCallback.
...
// PostCode calls admin.v1.AuthService.PostCode.
...
func (UnimplementedAuthServiceHandler) GetCallback(context.Context, *connect.Request[v1.GetCallbackRequest]) (*connect.Response[v1.GetCallbackResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admin.v1.AuthService.GetCallback is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) PostCode(context.Context, *connect.Request[v1.PostCodeRequest]) (*connect.Response[v1.PostCodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("admin.v1.AuthService.PostCode is not implemented"))
}
