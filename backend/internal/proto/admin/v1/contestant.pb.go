...
func file_admin_v1_contestant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_admin_v1_contestant_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_admin_v1_contestant_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_admin_v1_contestant_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_admin_v1_contestant_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GetContestantsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_v1_contestant_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*GetContestantsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_v1_contestant_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteContestantRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_v1_contestant_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*DeleteContestantResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
