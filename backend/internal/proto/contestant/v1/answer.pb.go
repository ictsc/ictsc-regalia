...
type Answer struct {
	...
	Point         *int64                 `protobuf:"varint,6,opt,name=point,proto3,oneof" json:"point,omitempty"`
...
func (x *PostAnswerRequest) GetBody() isPostAnswerRequest_Body {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *PostAnswerRequest) GetMultipleChoice() *MultipleChoiceAnswer {
	if x != nil {
		if x, ok := x.Body.(*PostAnswerRequest_MultipleChoice); ok {
			return x.MultipleChoice
		}
	}
	return nil
...
func (x *PostAnswerRequest) GetDescriptive() *DescriptiveAnswer {
	if x != nil {
		if x, ok := x.Body.(*PostAnswerRequest_Descriptive); ok {
			return x.Descriptive
		}
	}
	return nil
...
var file_contestant_v1_answer_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x18, 0x06, 0x20, 0x03, 0x28, 0x03, 0x42, 0x12, 0xba, 0x48, 0x0f, 0x92, 0x01, 0x0c,
	0x08, 0x01, 0x10, 0x0a, 0x18, 0x01, 0x22, 0x04, 0x22, 0x02, 0x28, 0x00, 0x52, 0x06, 0x61, 0x6e,
