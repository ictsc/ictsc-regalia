...
func file_contestant_v1_team_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_contestant_v1_team_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contestant_v1_team_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contestant_v1_team_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
