...
var file_contestant_v1_rule_proto_goTypes = []any{
...
func file_contestant_v1_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contestant_v1_rule_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_contestant_v1_rule_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_contestant_v1_rule_proto_msgTypes[2].Exporter = func(v any, i int) any {
