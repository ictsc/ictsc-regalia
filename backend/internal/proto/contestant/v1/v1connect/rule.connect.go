...
const (
	...
	RuleServiceName = "contestant.v1.RuleService"
)
...
const (
	...
	RuleServiceGetRuleProcedure = "/contestant.v1.RuleService/GetRule"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	ruleServiceServiceDescriptor       = v1.File_contestant_v1_rule_proto.Services().ByName("RuleService")
	ruleServiceGetRuleMethodDescriptor = ruleServiceServiceDescriptor.Methods().ByName("GetRule")
)

// RuleServiceClient is a client for the contestant.v1.RuleService service.
...
// NewRuleServiceClient constructs a client for the contestant.v1.RuleService service. By default,
...
// GetRule calls contestant.v1.RuleService.GetRule.
...
// RuleServiceHandler is an implementation of the contestant.v1.RuleService service.
...
func NewRuleServiceHandler(svc RuleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/contestant.v1.RuleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRuleServiceHandler) GetRule(context.Context, *connect.Request[v1.GetRuleRequest]) (*connect.Response[v1.GetRuleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("contestant.v1.RuleService.GetRule is not implemented"))
}
