...
const (
	...
	// RPC.
	AnswerServiceGetAnswersProcedure = "/contestant.v1.AnswerService/GetAnswers"
	// AnswerServicePostAnswerProcedure is the fully-qualified name of the AnswerService's PostAnswer
	// RPC.
	AnswerServicePostAnswerProcedure = "/contestant.v1.AnswerService/PostAnswer"
)
...
var (
	...
	answerServicePostAnswerMethodDescriptor = answerServiceServiceDescriptor.Methods().ByName("PostAnswer")
)
...
type AnswerServiceClient interface {
	...
	PostAnswer(context.Context, *connect.Request[v1.PostAnswerRequest]) (*connect.Response[v1.PostAnswerResponse], error)
}
...
func NewAnswerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AnswerServiceClient {
	...
	return &answerServiceClient{
		...
		postAnswer: connect.NewClient[v1.PostAnswerRequest, v1.PostAnswerResponse](
			httpClient,
			baseURL+AnswerServicePostAnswerProcedure,
			connect.WithSchema(answerServicePostAnswerMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type answerServiceClient struct {
	...
	postAnswer *connect.Client[v1.PostAnswerRequest, v1.PostAnswerResponse]
}
...
// GetAnswers calls contestant.v1.AnswerService.GetAnswers.
...
// PostAnswer calls contestant.v1.AnswerService.PostAnswer.
func (c *answerServiceClient) PostAnswer(ctx context.Context, req *connect.Request[v1.PostAnswerRequest]) (*connect.Response[v1.PostAnswerResponse], error) {
	return c.postAnswer.CallUnary(ctx, req)
}
...
func NewAnswerServiceHandler(svc AnswerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	answerServicePostAnswerHandler := connect.NewUnaryHandler(
		AnswerServicePostAnswerProcedure,
		svc.PostAnswer,
		connect.WithSchema(answerServicePostAnswerMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	return "/contestant.v1.AnswerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case AnswerServicePostAnswerProcedure:
			answerServicePostAnswerHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedAnswerServiceHandler) GetAnswers(context.Context, *connect.Request[v1.GetAnswersRequest]) (*connect.Response[v1.GetAnswersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("contestant.v1.AnswerService.GetAnswers is not implemented"))
}

func (UnimplementedAnswerServiceHandler) PostAnswer(context.Context, *connect.Request[v1.PostAnswerRequest]) (*connect.Response[v1.PostAnswerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("contestant.v1.AnswerService.PostAnswer is not implemented"))
}
