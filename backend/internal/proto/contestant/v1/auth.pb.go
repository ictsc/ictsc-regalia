...
var file_contestant_v1_auth_proto_goTypes = []interface{}{
...
func file_contestant_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contestant_v1_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contestant_v1_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contestant_v1_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contestant_v1_auth_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
