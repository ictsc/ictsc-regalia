...
const (
	...
	UserServiceName = "anita.v1.UserService"
)
...
const (
	...
	UserServiceGetUserProcedure = "/anita.v1.UserService/GetUser"
	// UserServiceGetUsersProcedure is the fully-qualified name of the UserService's GetUsers RPC.
	UserServiceGetUsersProcedure = "/anita.v1.UserService/GetUsers"
	// UserServicePostUserProcedure is the fully-qualified name of the UserService's PostUser RPC.
	UserServicePostUserProcedure = "/anita.v1.UserService/PostUser"
	// UserServicePatchUserProcedure is the fully-qualified name of the UserService's PatchUser RPC.
	UserServicePatchUserProcedure = "/anita.v1.UserService/PatchUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/anita.v1.UserService/DeleteUser"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	userServiceServiceDescriptor          = v1.File_anita_v1_user_proto.Services().ByName("UserService")
...
// UserServiceClient is a client for the anita.v1.UserService service.
...
// NewUserServiceClient constructs a client for the anita.v1.UserService service. By default, it
...
// GetUser calls anita.v1.UserService.GetUser.
...
// GetUsers calls anita.v1.UserService.GetUsers.
...
// PostUser calls anita.v1.UserService.PostUser.
...
// PatchUser calls anita.v1.UserService.PatchUser.
...
// DeleteUser calls anita.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the anita.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/anita.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anita.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUsers(context.Context, *connect.Request[v1.GetUsersRequest]) (*connect.Response[v1.GetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anita.v1.UserService.GetUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) PostUser(context.Context, *connect.Request[v1.PostUserRequest]) (*connect.Response[v1.PostUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anita.v1.UserService.PostUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) PatchUser(context.Context, *connect.Request[v1.PatchUserRequest]) (*connect.Response[v1.PatchUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anita.v1.UserService.PatchUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("anita.v1.UserService.DeleteUser is not implemented"))
}
