...
/**
 * @generated from message admin.v1.ShortProblem
 */
export class ShortProblem extends Message<ShortProblem> {
  /**
   * @generated from field: string id = 1;
   */
  id = "";
  ...
  /**
   * @generated from field: int32 current_point = 5;
   */
  currentPoint = 0;

  constructor(data?: PartialMessage<ShortProblem>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.ShortProblem";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "title", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "code", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "point", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 5, name: "current_point", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ShortProblem {
    return new ShortProblem().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ShortProblem {
    return new ShortProblem().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ShortProblem {
    return new ShortProblem().fromJsonString(jsonString, options);
  }

  static equals(a: ShortProblem | PlainMessage<ShortProblem> | undefined, b: ShortProblem | PlainMessage<ShortProblem> | undefined): boolean {
    return proto3.util.equals(ShortProblem, a, b);
  }
}
...
export class GetProblemsResponse extends Message<GetProblemsResponse> {
  /**
   * @generated from field: repeated admin.v1.ShortProblem problems = 1;
   */
  problems: ShortProblem[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "problems", kind: "message", T: ShortProblem, repeated: true },
  ]);
