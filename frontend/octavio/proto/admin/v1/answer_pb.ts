...
import { ProblemType } from "./problem_pb.js";
...
export class QuestionAnswer extends Message<QuestionAnswer> {
  ...
  static readonly typeName = "admin.v1.QuestionAnswer";
...
export class MultipleChoiceAnswer extends Message<MultipleChoiceAnswer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.MultipleChoiceAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class DescriptiveAnswer extends Message<DescriptiveAnswer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.DescriptiveAnswer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Answer extends Message<Answer> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.Answer";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "problem_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "team_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "problem_type", kind: "enum", T: proto3.getEnumType(ProblemType) },
    { no: 5, name: "multiple_choice", kind: "message", T: MultipleChoiceAnswer, oneof: "body" },
    { no: 6, name: "descriptive", kind: "message", T: DescriptiveAnswer, oneof: "body" },
    { no: 7, name: "point", kind: "scalar", T: 5 /* ScalarType.INT32 */, opt: true },
    { no: 8, name: "mark_published", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
...
export class GetAnswerRequest extends Message<GetAnswerRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.GetAnswerRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
export class GetAnswerResponse extends Message<GetAnswerResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.GetAnswerResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
export class Pagination extends Message<Pagination> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.Pagination";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "limit", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 2, name: "last_item_created_at", kind: "message", T: Timestamp },
  ]);
...
export class GetAnswersRequest extends Message<GetAnswersRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.GetAnswersRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "problem_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "team_id", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
...
export class GetAnswersResponse extends Message<GetAnswersResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.GetAnswersResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 */
export class PutPointRequest extends Message<PutPointRequest> {
  /**
   * @generated from field: string id = 1;
   */
  id = "";
  ...
  constructor(data?: PartialMessage<PutPointRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.PutPointRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "point", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PutPointRequest {
    return new PutPointRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PutPointRequest {
    return new PutPointRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PutPointRequest {
    return new PutPointRequest().fromJsonString(jsonString, options);
  }

  static equals(a: PutPointRequest | PlainMessage<PutPointRequest> | undefined, b: PutPointRequest | PlainMessage<PutPointRequest> | undefined): boolean {
    return proto3.util.equals(PutPointRequest, a, b);
  }
}
 ...
 */
export class PutPointResponse extends Message<PutPointResponse> {
  constructor(data?: PartialMessage<PutPointResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "admin.v1.PutPointResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PutPointResponse {
    return new PutPointResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PutPointResponse {
    return new PutPointResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PutPointResponse {
    return new PutPointResponse().fromJsonString(jsonString, options);
  }

  static equals(a: PutPointResponse | PlainMessage<PutPointResponse> | undefined, b: PutPointResponse | PlainMessage<PutPointResponse> | undefined): boolean {
    return proto3.util.equals(PutPointResponse, a, b);
  }
}
